...
namespace prova
{
    ...
    bool eh_particionada( const void * first, const void * last, size_t size,
            UnaryPredicate *p )
    {
        byte * n_first = static cast< byte * > (static cast< void * >(first));
        byte * n_last = static cast< byte * > (static cast< void * >(last));
            ...
            size_t size, const void * value, Compare *cmp )
    {
        ...
        byte * o_first = static cast< byte * > (static cast< void * >(first));
        byte * o_last = static cast< byte * > (static cast< void * >(last));
        byte * o_value = static cast< byte * > (static cast< void * >(value));
               ...
               const void *last_r, size_t size )
    {
 		byte * n_first = static cast< byte * > (static cast< void * >(first));
        byte * n_last = static cast< byte * > (static cast< void * >(last));
        const void* slow = first_r;
        const void* fast = last_r;
